...
public class StudentController {
    ...
    public Optional<Student> getOneStudent(@PathVariable Integer studentId) {
        Optional<Student> queredStudent = this.studentService.getSingleStudent(studentId);
    ...
    public String putMethodName(@PathVariable Integer studentId, @RequestBody Student data) {
